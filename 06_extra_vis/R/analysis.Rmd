...
# Save
ggplot2::ggsave(filename= "bar_N_DEGs.pdf", plot = bar_N_DE_plot, path = here::here("./out"), width= 7, height= 4)
...
GSEA_rhythmic_behaviour_zt <- plot_POI_fun(GSEA_zt[1]$BP,
                                           pathway = "GOBP_RHYTHMIC_BEHAVIOR",
                                           title= "GSEA: Rhythmic behaviour. Comparison: zt15 vs zt3")

ggplot2::ggsave(filename= "GSEA_rhythmic_behaviour_zt.pdf", plot= GSEA_rhythmic_behaviour_zt, path= here::here("./pathway_of_interest"), width = 7, height= 2.5)

# Hyopxia
GSEA_hypoxia_main <- plot_POI_fun(GSEA_main_effects[1]$BP,
                                           pathway= "GOBP_RESPONSE_TO_HYPEROXIA",
                                           title= "GSEA: Response to hyperoxia. Comparison: main effects")
GSEA_hypoxia_zt <- plot_POI_fun(GSEA_zt[1]$BP,
                                           pathway= "GOBP_RESPONSE_TO_HYPEROXIA",
                                           title= "GSEA: Response to hyperoxia. Comparison: zt15 vs zt3")

GSEA_hypoxia_genotype <- plot_POI_fun(GSEA_genotype[1]$BP,
                                           pathway= "GOBP_RESPONSE_TO_HYPEROXIA",
                                           title= "GSEA: Response to hyperoxia. Comparison: ko vs wt")
GSEA_hypoxia_exercise <- plot_POI_fun(GSEA_exercise[1]$BP,
                                           pathway= "GOBP_RESPONSE_TO_HYPEROXIA",
...
plot_list_save_function(list(GSEA_hypoxia_main= GSEA_hypoxia_main, 
                        ...
                        save_ch= "",
                        save_path= here::here("./pathway_of_interest"),
                        width= 7, height= 2.5)
...
```{r}
# Core clock genes
target <- c("Arntl", "Ciart",  "Clock", "Cry1",  "Dbp", "Nr1d1", "Npas2","Nr1d2", "Nr1d2", "Per1",  "Per3", "Nfil3")
...
plot_list_save_function(clock_plots, save_chr= "", save_path= here::here("./gene_of_interest/clock"), width= 7, height= 4)
...
plot_list_save_function(list(ox_phos_zt_plot= ox_phos_zt_plot,
                        ...
                        save_chr= "",
                        save_path= here::here("./gene_of_interest/oxphos"),
                        width= 7,
                        height= 4)
...
plot_list_save_function(list(HIF1a_main_effects_plot= HIF1a_main_effects_plot,
                        ...
                        save_chr= "",
                        save_path= here::here("./gene_of_interest/HIF1a"),
                        width= 7,
                        height= 2.5)
...
plot_list_save_function(list(hyperoxia_zt_plot= hyperoxia_zt_plot,
                        ...
                        save_chr= "",
                        save_path= here::here("./gene_of_interest/hyperoxia"),
                        width= 7,
                        height= 4)
...
plot_list_save_function(list(mito_RCC_assem_zt_plot= mito_RCC_assem_zt_plot, 
                        ...
                        save_chr= "",
                        save_path= here::here("./gene_of_interest/mitochondria"),
                        width= 7,
                        height= 4)
...
# Save
ggplot2::ggplot(filename = "bar_N_DE_per_pathway.pdf", plot = out, path = here::here("./out/"), width= 6, height= 8)
...
# Mannose 6 phosphate GO pathways
```{r}
...
temp_dat <- temp_dat |> 
  dplyr::mutate(comp= factor(comp, levels = c("zt3_sed", "zt3_ex")))
...
# Specific genes in the Mannose-6-phosphate pathway
```{r}
